...
import { ChevronDownIcon, DEFAULT_ICON_COLOR, DEFAULT_ICON_SIZE } from '@ui/atoms/icons'

const meta = {
  title: 'UI/Atoms/Icons/ChevronDownIcon',
  ...
  parameters: {
    docs: {
      description: {
        component: [
          'A single downward chevron — expand, or open a dropdown.',
          '',
...
export const Sizes: Story = {
  render: ({ color }) => (
    <View style={styles.row}>
      ...
      <ChevronDownIcon size={24} color={color} />
      <ChevronDownIcon size={32} color={color} />
      <ChevronDownIcon size={48} color={color} />
      <ChevronDownIcon size={64} color={color} />
    </View>
  ),
}
...
export const Palette: Story = {
  render: ({ size }) => (
    <View style={styles.row}>
      <ChevronDownIcon size={size} color={Colors.text.default} />
      <ChevronDownIcon size={size} color={Colors.text.light} />
      <ChevronDownIcon size={size} color={Colors.primary.default} />
      <ChevronDownIcon size={size} color={Colors.primary.dark} />
      <ChevronDownIcon size={size} color={Colors.border.dark} />
    </View>
  ),
}
