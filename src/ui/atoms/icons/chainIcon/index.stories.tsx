...
import { ChainIcon, DEFAULT_ICON_COLOR, DEFAULT_ICON_SIZE } from '@ui/atoms/icons'

const meta = {
  title: 'UI/Atoms/Icons/ChainIcon',
  component: ChainIcon,
  ...
  parameters: {
    docs: {
      description: {
        component: [
          'Two interlocking links — an attached link or external reference.',
          '',
...
export const Sizes: Story = {
  render: ({ color }) => (
    <View style={styles.row}>
      <ChainIcon size={16} color={color} />
      <ChainIcon size={24} color={color} />
      <ChainIcon size={32} color={color} />
      <ChainIcon size={48} color={color} />
      <ChainIcon size={64} color={color} />
    </View>
  ),
}
...
export const Palette: Story = {
  render: ({ size }) => (
    <View style={styles.row}>
      <ChainIcon size={size} color={Colors.text.default} />
      <ChainIcon size={size} color={Colors.text.light} />
      <ChainIcon size={size} color={Colors.primary.default} />
      <ChainIcon size={size} color={Colors.primary.dark} />
      <ChainIcon size={size} color={Colors.border.dark} />
    </View>
  ),
}
