...
import { DEFAULT_ICON_COLOR, DEFAULT_ICON_SIZE, DocumentIcon } from '@ui/atoms/icons'

const meta = {
  title: 'UI/Atoms/Icons/DocumentIcon',
  ...
  parameters: {
    docs: {
      description: {
        component: [
          'A page with a folded corner and text lines — a document.',
          '',
...
export const Sizes: Story = {
  render: ({ color }) => (
    <View style={styles.row}>
      ...
      <DocumentIcon size={48} color={color} />
      <DocumentIcon size={64} color={color} />
    </View>
  ),
}
...
export const Palette: Story = {
  render: ({ size }) => (
    <View style={styles.row}>
      <DocumentIcon size={size} color={Colors.text.default} />
      <DocumentIcon size={size} color={Colors.text.light} />
      <DocumentIcon size={size} color={Colors.primary.default} />
      <DocumentIcon size={size} color={Colors.primary.dark} />
      <DocumentIcon size={size} color={Colors.border.dark} />
    </View>
  ),
}
