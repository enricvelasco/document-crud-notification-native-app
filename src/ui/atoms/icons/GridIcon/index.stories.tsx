...
import { DEFAULT_ICON_COLOR, DEFAULT_ICON_SIZE, GridIcon } from '@ui/atoms/icons'

const meta = {
  title: 'UI/Atoms/Icons/GridIcon',
  component: GridIcon,
  ...
  parameters: {
    docs: {
      description: {
        component: [
          'A two-by-two grid — the grid layout in a layout switcher.',
          '',
...
export const Sizes: Story = {
  render: ({ color }) => (
    <View style={styles.row}>
      <GridIcon size={16} color={color} />
      <GridIcon size={24} color={color} />
      <GridIcon size={32} color={color} />
      <GridIcon size={48} color={color} />
      <GridIcon size={64} color={color} />
    </View>
  ),
}
...
export const Palette: Story = {
  render: ({ size }) => (
    <View style={styles.row}>
      <GridIcon size={size} color={Colors.text.default} />
      <GridIcon size={size} color={Colors.text.light} />
      <GridIcon size={size} color={Colors.primary.default} />
      <GridIcon size={size} color={Colors.primary.dark} />
      <GridIcon size={size} color={Colors.border.dark} />
    </View>
  ),
}
