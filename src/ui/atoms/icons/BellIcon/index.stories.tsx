...
import { BellIcon, DEFAULT_ICON_COLOR, DEFAULT_ICON_SIZE } from '@ui/atoms/icons'

const meta = {
  title: 'UI/Atoms/Icons/BellIcon',
  component: BellIcon,
  ...
  parameters: {
    docs: {
      description: {
        component: [
          'A bell — notifications, and the entry point to their list.',
          '',
...
export const Sizes: Story = {
  render: ({ color }) => (
    <View style={styles.row}>
      <BellIcon size={16} color={color} />
      <BellIcon size={24} color={color} />
      <BellIcon size={32} color={color} />
      <BellIcon size={48} color={color} />
      <BellIcon size={64} color={color} />
    </View>
  ),
}
...
export const Palette: Story = {
  render: ({ size }) => (
    <View style={styles.row}>
      <BellIcon size={size} color={Colors.text.default} />
      <BellIcon size={size} color={Colors.text.light} />
      <BellIcon size={size} color={Colors.primary.default} />
      <BellIcon size={size} color={Colors.primary.dark} />
      <BellIcon size={size} color={Colors.border.dark} />
    </View>
  ),
}
