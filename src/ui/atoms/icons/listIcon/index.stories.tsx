...
import { DEFAULT_ICON_COLOR, DEFAULT_ICON_SIZE, ListIcon } from '@ui/atoms/icons'

const meta = {
  title: 'UI/Atoms/Icons/ListIcon',
  component: ListIcon,
  ...
  parameters: {
    docs: {
      description: {
        component: [
          'Three bulleted rows — the list layout in a layout switcher.',
          '',
...
export const Sizes: Story = {
  render: ({ color }) => (
    <View style={styles.row}>
      <ListIcon size={16} color={color} />
      <ListIcon size={24} color={color} />
      <ListIcon size={32} color={color} />
      <ListIcon size={48} color={color} />
      <ListIcon size={64} color={color} />
    </View>
  ),
}
...
export const Palette: Story = {
  render: ({ size }) => (
    <View style={styles.row}>
      <ListIcon size={size} color={Colors.text.default} />
      <ListIcon size={size} color={Colors.text.light} />
      <ListIcon size={size} color={Colors.primary.default} />
      <ListIcon size={size} color={Colors.primary.dark} />
      <ListIcon size={size} color={Colors.border.dark} />
    </View>
  ),
}
