...
import { DEFAULT_ICON_COLOR, DEFAULT_ICON_SIZE, SortIcon } from '@ui/atoms/icons'

const meta = {
  title: 'UI/Atoms/Icons/SortIcon',
  component: SortIcon,
  ...
  parameters: {
    docs: {
      description: {
        component: [
          'A chevron up over a chevron down — the "sort this column" affordance.',
          '',
...
export const Sizes: Story = {
  render: ({ color }) => (
    <View style={styles.row}>
      <SortIcon size={16} color={color} />
      <SortIcon size={24} color={color} />
      <SortIcon size={32} color={color} />
      <SortIcon size={48} color={color} />
      <SortIcon size={64} color={color} />
    </View>
  ),
}
...
export const Palette: Story = {
  render: ({ size }) => (
    <View style={styles.row}>
      <SortIcon size={size} color={Colors.text.default} />
      <SortIcon size={size} color={Colors.text.light} />
      <SortIcon size={size} color={Colors.primary.default} />
      <SortIcon size={size} color={Colors.primary.dark} />
      <SortIcon size={size} color={Colors.border.dark} />
    </View>
  ),
}
